    ...
    >
      <div className="space-y-3 max-w-xl">
        ...
        <p className="text-sm text-slate-400 leading-relaxed">
          KEF airport transfers, signature day tours, and wedding chauffeur — managed by Iceland Limousine,
          part of the TFO Private ecosystem.
        </p>
      </div>
      <div className="flex flex-wrap gap-3 shrink-0">
        <a
          href={SIBLING.limousineBook}
        ...
        >
          TFO Private <ArrowRight className="w-3.5 h-3.5" />
        </a>
      </div>
    </motion.div>
  </section>

        ...
        <div className="relative z-10 max-w-[1720px] w-full mx-auto px-6 sm:px-10 lg:px-16 xl:px-20 pb-16 sm:pb-24 pt-32">
          ...
          >
            ...
            <a
              ...
              className="shrink-0 inline-flex items-center bg-white rounded-sm px-2 py-1.5 shadow-lg hover:shadow-xl transition-shadow"
        ...
        <div className="max-w-[1720px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-12">
            ...
            >
              <img
                src={IMAGES.crew}
                alt="TFO Jets flight crew in the cockpit"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
              />

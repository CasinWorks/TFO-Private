...
VERSION:2.0
PRODID:-//TFO Private//Iceland Limousine Chauffeur//EN
BEGIN:VEVENT
SUMMARY:TFO Private Chauffeur: ${bookingData.pickupAddress} to ${bookingData.dropoffAddress}
DESCRIPTION:Reservation #${bookingData.referenceId} with Iceland Limousine. Vehicle: ${vehicle.name}. Lead Passenger: ${bookingData.guestName}.
...
END:VCALENDAR`;
    ...
    link.setAttribute('download', `TFO-Reservation-${bookingData.referenceId}.ics`);

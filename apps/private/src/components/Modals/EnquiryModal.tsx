...
const SERVICE_OPTIONS = [
  ...
  {
    id: 'jets',
    label: 'TFO Jets · Ferry & Delivery',
    hint: 'Aircraft delivery, demo & ferry flights',
  },
  {
    id: 'limousine',
    label: 'Iceland Limousine',
                ...
                {step === 'welcome' && (
                  <div className="space-y-10">
                    ...
                    <motion.div variants={stepChild} className="flex flex-wrap gap-4 pt-2">
                      ...
                      >
                        <Phone className="w-3.5 h-3.5" /> +354 588 5522
                      </a>
                    </motion.div>
                  </div>
                )}
                ...
                {step === 'sent' && (
                  <div className="text-center space-y-8 py-8 sm:py-12">
                    ...
                    <motion.div variants={stepChild} className="flex flex-wrap justify-center gap-4 pt-2">
                      ...
                      <a
                        href="mailto:concierge@tfoprivate.com"
                      ...
                      >
                        <Mail className="w-3.5 h-3.5" /> concierge@tfoprivate.com
                      </a>
                    </motion.div>
                  </div>
                )}

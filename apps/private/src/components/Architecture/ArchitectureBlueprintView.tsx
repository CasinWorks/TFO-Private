      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="space-y-3 border-b border-white/10 pb-8">
          ...
          <h1 className="font-serif-luxury text-3xl sm:text-5xl text-white">
            TFO Private Multi-Site Digital Ecosystem Architecture
          </h1>

          <p className="text-slate-400 text-sm max-w-3xl leading-relaxed">
            Comprehensive blueprint integrating <strong className="text-white">Iceland Limousine</strong> (luxury ground transportation) and <strong className="text-white">TFO Jets</strong> (private aviation &amp; ferry operations) under a unified <strong className="text-[#C5A880]">"From Runway to Road"</strong> luxury portal.
          </p>
        </div>
            ...
            <div className="bg-[#0B0F15] border border-white/10 rounded-2xl p-6 sm:p-8 space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-2">
                ...
                <div className="bg-black/60 border border-[#C5A880]/50 rounded-xl p-6 space-y-4 relative">
                  ...
                  <h3 className="font-serif-luxury text-xl text-white">TFO Private Landing</h3>
                ...
                <div className="bg-black/60 border border-white/15 rounded-xl p-6 space-y-4 relative">
                  ...
                  <h3 className="font-serif-luxury text-xl text-white">Iceland Limousine Rebuild</h3>
                  <p className="text-xs text-slate-400 leading-relaxed">
                ...
                <div className="bg-black/60 border border-white/15 rounded-xl p-6 space-y-4 relative">
                  ...
                  <h3 className="font-serif-luxury text-xl text-white">TFO Jets Rebuild</h3>
                  <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="space-y-8">
            <div className="bg-[#0B0F15] border border-white/10 rounded-2xl p-6 sm:p-8 space-y-6">
              <h2 className="font-display-luxury text-lg font-bold text-white uppercase tracking-wider flex items-center gap-2">
                ...
                Iceland Limousine 5-Step Booking State Machine
              </h2>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="p-4 rounded-xl border border-white/10 space-y-2" style={{ backgroundColor: '#C5A880' }}>
                    ...
                    <div className="text-[10px] text-[#080B0E]/80">TFO Warm Champagne Gold</div>
                  </div>

...
export const AviationQuoteEngine: React.FC<AviationQuoteEngineProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const ref = `TFO-AIR-${Math.floor(100000 + Math.random() * 900000)}`;
    setSubmitted(true);
    onInquirySubmitted({
      ...inquiry,
      referenceCode: ref,
      ...
      <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
        ...
        <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-xs text-slate-400">
            ...
            <span>Confidential RFP submitted directly to TFO Duty Captain. Response within 60 mins.</span>
          </div>

...
function wrapEmail(title: string, intro: string, b: BookingPayload) {
  ...
  <div style="max-width:560px;margin:32px auto;background:#fff;border:1px solid #e2e8f0;">
    <div style="padding:24px 28px;background:#080B0E;color:#C5A880;font-size:13px;letter-spacing:0.2em;text-transform:uppercase;">Iceland Limousine</div>
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const fromName = process.env.BOOKING_FROM_NAME || 'Iceland Limousine';

      ...
      <div className="site-shell py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-3">
            ...
            <a href="tel:+3545885522" className="flex items-center gap-2 text-xs hover:text-[#C5A880]">
              <Phone className="w-3.5 h-3.5 text-[#C5A880]" /> +354 588 5522
            </a>
            <a href="mailto:concierge@icelandlimousine.com" className="flex items-center gap-2 text-xs hover:text-[#C5A880]">
              <Mail className="w-3.5 h-3.5 text-[#C5A880]" /> concierge@icelandlimousine.com
            </a>
          </div>
        </div>
